	...
	<a-card :bordered="false">
		...
		<a-form ref="searchFormRef" name="advanced_search" :model="searchFormState" class="ant-advanced-search-form">
			<a-row :gutter="24">
				...
				<a-col :span="6">
					<a-form-item label="扫描类型" name="attackType">
						<a-input v-model:value="searchFormState.attackType" placeholder="例如: SYN Scan" allow-clear />
					</a-form-item>
				</a-col>
				<a-col :span="6">
		...
		>
			<template #bodyCell="{ column, record }">
				...
				<template v-if="column.dataIndex === 'requestUri'">
					<a-tooltip :title="record.requestUri" placement="topLeft">
						<div class="truncate" style="max-width: 150px;">{{ record.requestUri }}</div>
					</a-tooltip>
				</template>
			</template>
		</s-table>
...
const columns = [
	...
	{ title: 'userAgent', dataIndex: 'userAgent', width: 160 },
	{ title: '攻击地址', dataIndex: 'requestUri', width: 100 }
]
